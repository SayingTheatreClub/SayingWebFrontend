        ...
        <VerticalTimeline>
          ...
          >
            ...
            <p>
              <text className="about-text">
                戏演剧社与ISS联合举办的Global
                Cafe活动，传播中国文化，宣传话剧艺术，介绍话剧表演的台前与幕后。
              </text>
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">CSSA春晚小品</h4>
            <p>
              <text className="about-text">
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">《茶馆》观剧</h4>
            <p>
              <text className="about-text">
          ...
          >
            ...
            <p>
              <text className="about-text">
                3月29日11:39
                我们建立了自己的微信公众号并发送了第一篇推送《初次见面！欢迎来到戏言剧社主频道！》。
              </text>
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">《旧事》公演</h4>
            <p>
              <text className="about-text">
                《旧事》的剧本改编自悬疑灵异题材网络剧《灵魂摆渡》。
                “是否混沌时代笑语比悲悯沉重/ 多少爱恨情仇冷眼看透/
                最后蝴蝶飞过冰冷的山丘/ 全都化作乌有”
              </text>
            </p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <p>
              <text className="about-text">
                “那一年，在南阳街，有一棵桃树。桃树上面开花了。”
                戏言第一次的公开亮相，给大家的新年增添的一分喜庆。
              </text>
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">第一次会议</h4>
            <p>
              <text className="about-text">
